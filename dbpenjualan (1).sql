...
--
-- Stand-in struktur untuk tampilan `vbarang1`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `vbarang1` (
`idbarang` int(11)
,`nmbarang` varchar(50)
...
--
-- Struktur untuk view `vbarang1`
--
DROP TABLE IF EXISTS `vbarang1`;
...
--
ALTER TABLE `tdistributor`
  MODIFY `iddist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
